...
public class TbGoodsDesc {
    ...
    public TbGoodsDesc(Long goodsId, String introduction, String specificationItems, String customAttributeItems, String itemImages, String packageList, String saleService) {
